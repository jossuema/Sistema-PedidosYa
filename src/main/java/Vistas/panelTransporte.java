...
import Controladores.cTransporte;
 ...
 * @author berth
 */
public class panelTransporte extends javax.swing.JPanel {

    //datos globales
    public cTransporte list = new cTransporte();
    ...
    public Transporte leer() {
        Transporte ob = null;
        if (form_validado()) {
            ob = new Transporte();
            ob.Placa = txtPlaca.getText();
            ob.Tipo_transporte = jComboBox1.getSelectedItem().toString();
            ob.Descripcion = txtDescripcion.getText();
            ob.Disponibilidad = jRadioButton1.isSelected();
            ob.Cedula_repartidor = txtCedulaRepartidor.getText();
            ob.Modelo_vehiculo = txtModelo.getText();
    ...
    public boolean form_validado() {
        ...
        //validar requerido
        if (!Validaciones.esRequerido(txtPlaca)) {
            ok = false;
            men += ", Placa";
        }
        ...
        if(!Validaciones.esCedula(txtCedulaRepartidor)){
            ok = false;
            men += ", Cedula Repartidor";
        }
        
        if(!Validaciones.esRequerido(txtModelo)){
            ok = false;
            men += ", Modelo vehiculo";
        }
    ...
    public void quitar_validaciones() {
        ...
        Validaciones.pinta_text(txtCedulaRepartidor);
    ...
    public final void ver_registro(int pos) {
        if (pos >= 0 && pos < list.Count()) {
            Transporte ob = list.getTransporte(pos);
            txtPlaca.setText(ob.Placa);
            jComboBox1.setSelectedItem(ob.Tipo_transporte);
            txtDescripcion.setText(ob.Descripcion);
            if(ob.Disponibilidad){
                jRadioButton1.setSelected(true);
            }else{
                jRadioButton2.setSelected(false);
            }
            txtCedulaRepartidor.setText(ob.Cedula_repartidor);
            txtModelo.setText(ob.Modelo_vehiculo);
    ...
    public void buscar_varios() {
        try {
            cTransporte p = list.buscar_Placa(txtDato.getText()); //busca por cedula
            if (p.Count() == 0) {
    ...
    public final void habilitar_textos(Boolean ok) {
        ...
        jRadioButton1.setEnabled(ok);
        jRadioButton2.setEnabled(ok);
        txtDescripcion.setEditable(ok);
        txtCedulaRepartidor.setEditable(ok);
        txtModelo.setEditable(ok);
    }
     ...
     */
    public panelTransporte(String fun) {
        this.funcion =  fun;
        initComponents();
        try {
            list.leer();
        } catch (IOException ex) {
            Logger.getLogger(panelTransporte.class.getName()).log(Level.SEVERE, null, ex);
        }
		//formato de la tabla
    ...
    public final void desactivar_botones() {
    ...
    private void initComponents() {
        ...
        panelDatos.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos del Repartidor", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14))); // NOI18N
        ...
        jLabel5.setText("Cedula repartidor:");
        ...
        txtCedulaRepartidor.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtCedulaRepartidorKeyReleased(evt);
            }
        });
        ...
        jLabel6.setText("Modelo vehiculo:");
            ...
            .addGroup(panelDatosLayout.createSequentialGroup()
                ...
                .addGroup(panelDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelDatosLayout.createSequentialGroup()
                        ...
                        .addGap(49, 49, 49)
                        .addGroup(panelDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtModelo, javax.swing.GroupLayout.PREFERRED_SIZE, 571, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(panelDatosLayout.createSequentialGroup()
                        ...
                        .addGroup(panelDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtCedulaRepartidor, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        panelDatosLayout.setVerticalGroup(
            ...
            .addGroup(panelDatosLayout.createSequentialGroup()
                ...
                .addGroup(panelDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtCedulaRepartidor, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(panelDatosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jButton1.setText("Seleccionar Transporte");
    ...
    private void txtCedulaRepartidorKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCedulaRepartidorKeyReleased
        if (Validaciones.esCedula(txtCedulaRepartidor))
            Validaciones.pinta_text(txtCedulaRepartidor);
    }//GEN-LAST:event_txtCedulaRepartidorKeyReleased
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int pos = tabla.getSelectedRow();
        if(pos>=0&&pos<list.Count()){
            Transporte cl = list.getTransporte(pos);
            if(!cl.Disponibilidad){
                frmPrincipal.lbMensaje.setText("Transporte no disponible");
            }else{
                frmPrincipal.transporte = cl;
                frmPrincipal.mostrarMain("Transporte");
            }
        }else{
            frmPrincipal.lbMensaje.setText("Escoja un repartidor");
        }
